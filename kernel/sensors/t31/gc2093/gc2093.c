 ...
 *
 * GC2093 1080p90/720p120 high framerate mod for t31
 * Tested with: Vcore=1.24V & isp_clk=240M & avpu_clk=500M
 * https://github.com/libc0607/openipc-openingenic
 */
...
#define GC2093_SUPPORT_1080P90_SCLK (132750000)
#define GC2093_SUPPORT_720P120_SCLK (119250000)
...
struct tx_isp_sensor_attribute gc2093_attr={
	...
	.max_integration_time_native = 1118 - 4,
	.integration_time_limit = 1118 - 4,
	.total_width = 2628,
	.total_height = 1118,
	.max_integration_time = 1118 - 4,
...
// mclk=27MHz 
static struct regval_list gc2093_init_regs_1920_1080_90fps_mipi_lin[] = {
    /****system****/
    {0x03fe, 0xf0},
    {0x03fe, 0xf0},
    {0x03fe, 0xf0},
    ...
    {0x0013, 0x15},
    {0x0019, 0x0c},
    {0x0041, 0x04},	// frame length = 0x045e = 1118
    {0x0042, 0x5e},
    {0x0053, 0x60},
    {0x008d, 0x92},
    {0x0090, 0x00},
...
static struct tx_isp_sensor_win_setting gc2093_win_sizes[] = {
	{
		...
		.regs 		= gc2093_init_regs_1920_1080_90fps_mipi_lin,
	},
	{
		.width		= 1280,
		.height		= 720,
...
static int gc2093_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	wpclk = GC2093_SUPPORT_1080P90_SCLK;
	switch(sensor_resolution)
    {
        ...
        case TX_SENSOR_RES_100:
            wpclk = GC2093_SUPPORT_720P120_SCLK;
            break;
        default:
            break;
    }
...
static int gc2093_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	switch(sensor_resolution)
	{
		case TX_SENSOR_RES_200:
			...
			gc2093_attr.total_width = 2628;
			gc2093_attr.total_height = 1118;
			gc2093_attr.max_integration_time_native = 1118 - 4;
			gc2093_attr.integration_time_limit = 1118 - 4;
			gc2093_attr.max_integration_time = 1118 - 4;
			gc2093_attr.max_integration_time_short = 4;
			break;
		case TX_SENSOR_RES_100:
			wsize = &gc2093_win_sizes[1];
			sensor_max_fps = TX_SENSOR_MAX_FPS_120;
			gc2093_attr.data_type = data_type;
			gc2093_mipi_linear.image_twidth = 1280;
			gc2093_mipi_linear.image_theight = 720;
			memcpy(&gc2093_attr.mipi, &gc2093_mipi_linear, sizeof(gc2093_mipi_linear));
			gc2093_attr.one_line_expr_in_us = 30;
			gc2093_attr.total_width = 2628;
			gc2093_attr.total_height = 750;
			gc2093_attr.max_integration_time_native = 750 - 4;
			gc2093_attr.integration_time_limit = 750 - 4;
			gc2093_attr.max_integration_time = 750 - 4;
			gc2093_attr.max_integration_time_short = 4;
			break;
		default:
